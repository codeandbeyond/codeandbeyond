...
public class NextGreatElements {
    public static void main(String[] args) {
        ...
        NextGreatElements nextGreatElements = new NextGreatElements();
        int[] result = nextGreatElements.nextGreaterElement(nums1, nums2);
        for (int num : result) {
    ...
    public int[] nextGreaterElement(int[] nums1, int[] nums2) {
        ...
        for (int i = 0; i < nums2.length; i++) {
            int greater = nums2[i];
            while (!stack.isEmpty() && stack.peek() < greater) {
                map.put(stack.pop(), greater);
            }
            stack.push(greater);
        }
        int index = 0;
