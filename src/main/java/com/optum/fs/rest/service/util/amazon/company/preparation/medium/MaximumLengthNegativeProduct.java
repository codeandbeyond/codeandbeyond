...
public class MaximumLengthNegativeProduct {
    public static void main(String[] args) {
        MaximumLengthNegativeProduct maximumLengthNegativeProduct = new MaximumLengthNegativeProduct();
        maximumLengthNegativeProduct.getMaxLen(new int[]{0,1,-2,-3,-4});
    }
